      ...
      <header className="bg-white border-b border-[#EBEBEB] sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-[#222222] tracking-tight">{t('title')}</h1>
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/history"
                className="h-10 px-4 rounded-full border border-[#DDDDDD] bg-white flex items-center gap-2 hover:border-[#222222] hover:shadow-sm transition-all"
              >
                <svg className="w-4 h-4 text-[#222222]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-sm font-medium text-[#222222]">{tDeals('dealHistory')}</span>
              </Link>
              <button
